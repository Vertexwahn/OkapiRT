# Copied from https://github.com/bazelbuild/bazel/blob/master/src/main/res/winsdk_toolchain.bzl
...
WINDOWS_RESOURCE_COMPILER_TOOLCHAIN_TYPE = "@de_vertexwahn//okapi/res:toolchain_type"
